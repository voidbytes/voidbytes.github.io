...
![堆内存结构](jvm-garbage-collection/hotspot-heap-structure-20230614222444908.png)

**JDK 8 版本之后 PermGen(永久) 已被 Metaspace(元空间) 取代，元空间使用的是直接内存** 。

关于堆空间结构更详细的介绍，可以回过头看看 [Java 内存区域详解](./Java内存区域详解.md) 这篇文章。
...
通过以下方式运行：
![](jvm-garbage-collection/25178350.png)

添加的参数：`-XX:+PrintGCDetails`
![](jvm-garbage-collection/run-with-PrintGCDetails.png)

运行结果 (红色字体描述有误，应该是对应于 JDK1.7 的永久代)：

![](jvm-garbage-collection/28954286.jpg)
...
![](jvm-garbage-collection/28128785.jpg)
...
>
> ![](jvm-garbage-collection/image-20210523201742303.png)
>
> **动态年龄计算的代码如下：**
>
> ```c++
...
![R 大的回答](jvm-garbage-collection/rf-hotspot-vm-gc.png)
...
![对象之间循环引用](jvm-garbage-collection/object-circular-reference.png)
...
![可达性分析算法](jvm-garbage-collection/jvm-gc-roots.png)
...
![Java 引用类型总结](jvm-garbage-collection/java-reference-type.png)
...
![标记-清除算法](jvm-garbage-collection/mark-and-sweep-garbage-collection-algorithm.png)
...
![复制算法](jvm-garbage-collection/copying-garbage-collection-algorithm.png)
...
![标记-整理算法](jvm-garbage-collection/mark-and-compact-garbage-collection-algorithm.png)
...
![Serial 收集器](jvm-garbage-collection/serial-garbage-collector.png)
...
![ParNew 收集器 ](jvm-garbage-collection/parnew-garbage-collector.png)
...
![Parallel Old收集器运行示意图](jvm-garbage-collection/parallel-scavenge-garbage-collector.png)
...
![CMS 收集器](jvm-garbage-collection/cms-garbage-collector.png)
...
![G1 收集器](jvm-garbage-collection/g1-garbage-collector.png)
...
## 参考
- javaguide: https://javaguide.cn/java/jvm/
